  ...
  <body  onload="checkTelegramStatus()">
    ...
    <div id="vk" class="tab-pane fade">
      ...
      <div class="row footer" align="center">
				<b text-align="center" >Вход через социальные сети:<p></>
      <ul class="nav nav-tabs navcenter">
				<li class="active"><a data-toggle="tab" href="#mail"><img src="../img/Email_Logo.png" width="35"
					height="35" alt="Email"></a></li>
				<li><a data-toggle="tab" href="#vk"><img src="../img/VK_Logo.png" width="35"
					height="35" alt="Vkontakte"></a></li>
        <li><a data-toggle="tab" href="#telegram"<?php if ($_COOKIE["Telegram_blocked"]=='yes'):?>hidden ><?php endif; ?>><img src="../img/Telegram_Logo.png" width="35"
					height="35" alt="Telegram"></a></li>
        <li><a data-toggle="tab" href="#google"><img src="../img/Google_Logo.png" width="35"
					height="35" alt="Google"></a></li>
			</ul>
      </div>
